...
def output_actionadextension(data_object):
    ...
    output_status_message(
        "TrackingUrlTemplate: {0}".format(data_object.TrackingUrlTemplate)
    )
...
def output_ad(data_object):
    ...
    output_status_message(
        "AdFormatPreference: {0}".format(data_object.AdFormatPreference)
    )
...
def output_adextensioneditorialreasoncollection(data_object):
    if data_object is None:
        return
    output_status_message(
        "* * * Begin output_adextensioneditorialreasoncollection * * *"
    )
...
def output_adgroup(data_object):
    ...
    output_status_message(
        "AudienceAdsBidAdjustment: {0}".format(data_object.AudienceAdsBidAdjustment)
    )
...
def output_assetlink(data_object):
    ...
    output_status_message(
        "AssetPerformanceLabel: {0}".format(data_object.AssetPerformanceLabel)
    )
    output_status_message("EditorialStatus: {0}".format(data_object.EditorialStatus))
...
def output_audience(data_object):
    ...
    output_status_message(
        "AudienceNetworkSize: {0}".format(data_object.AudienceNetworkSize)
    )
    ...
    output_status_message("Id: {0}".format(data_object.Id))
    output_status_message(
        "MembershipDuration: {0}".format(data_object.MembershipDuration)
    )
    output_status_message("Name: {0}".format(data_object.Name))
...
def output_bmcstore(data_object):
    ...
    output_status_message(
        "IsProductAdsEnabled: {0}".format(data_object.IsProductAdsEnabled)
    )
    output_status_message("Name: {0}".format(data_object.Name))
...
def output_calladextension(data_object):
    ...
    output_status_message(
        "IsCallTrackingEnabled: {0}".format(data_object.IsCallTrackingEnabled)
    )
    output_status_message("PhoneNumber: {0}".format(data_object.PhoneNumber))
    output_status_message(
        "RequireTollFreeTrackingNumber: {0}".format(
            data_object.RequireTollFreeTrackingNumber
        )
    )
...
def output_conversiongoal(data_object):
    ...
    output_status_message(
        "ConversionWindowInMinutes: {0}".format(data_object.ConversionWindowInMinutes)
    )
    output_status_message("CountType: {0}".format(data_object.CountType))
    output_status_message(
        "ExcludeFromBidding: {0}".format(data_object.ExcludeFromBidding)
    )
    output_status_message("Id: {0}".format(data_object.Id))
    output_status_message("Name: {0}".format(data_object.Name))
    ...
    output_status_message("Type: {0}".format(data_object.Type))
    output_status_message(
        "ViewThroughConversionWindowInMinutes: {0}".format(
            data_object.ViewThroughConversionWindowInMinutes
        )
    )
...
def output_durationgoal(data_object):
    ...
    output_status_message(
        "MinimumDurationInSeconds: {0}".format(data_object.MinimumDurationInSeconds)
    )
...
def output_eventgoal(data_object):
    ...
    output_status_message("ActionOperator: {0}".format(data_object.ActionOperator))
    output_status_message(
        "CategoryExpression: {0}".format(data_object.CategoryExpression)
    )
    output_status_message("CategoryOperator: {0}".format(data_object.CategoryOperator))
...
def output_experiment(data_object):
    ...
    output_date(data_object.EndDate)
    output_status_message(
        "ExperimentCampaignId: {0}".format(data_object.ExperimentCampaignId)
    )
    ...
    output_date(data_object.StartDate)
    output_status_message(
        "TrafficSplitPercent: {0}".format(data_object.TrafficSplitPercent)
    )
...
def output_geopoint(data_object):
    ...
    output_status_message(
        "LatitudeInMicroDegrees: {0}".format(data_object.LatitudeInMicroDegrees)
    )
    output_status_message(
        "LongitudeInMicroDegrees: {0}".format(data_object.LongitudeInMicroDegrees)
    )
...
def output_inheritfromparentbiddingscheme(data_object):
    ...
    output_status_message(
        "InheritedBidStrategyType: {0}".format(data_object.InheritedBidStrategyType)
    )
...
def output_mediaassociation(data_object):
    ...
    output_status_message("EntityId: {0}".format(data_object.EntityId))
    output_status_message(
        "MediaEnabledEntity: {0}".format(data_object.MediaEnabledEntity)
    )
...
def output_offlineconversion(data_object):
    ...
    output_status_message(
        "ConversionCurrencyCode: {0}".format(data_object.ConversionCurrencyCode)
    )
...
def output_pagesviewedpervisitgoal(data_object):
    ...
    output_status_message(
        "MinimumPagesViewed: {0}".format(data_object.MinimumPagesViewed)
    )
...
def output_pagevisitorswhodidnotvisitanotherpagerule(data_object):
    if data_object is None:
        return
    output_status_message(
        "* * * Begin output_pagevisitorswhodidnotvisitanotherpagerule * * *"
    )
    ...
    output_status_message(
        "* * * End output_pagevisitorswhodidnotvisitanotherpagerule * * *"
    )
...
def output_pagevisitorswhovisitedanotherpagerule(data_object):
    if data_object is None:
        return
    output_status_message(
        "* * * Begin output_pagevisitorswhovisitedanotherpagerule * * *"
    )
    ...
    output_array_of_ruleitemgroup(data_object.RuleItemGroups)
    output_status_message(
        "* * * End output_pagevisitorswhovisitedanotherpagerule * * *"
    )
...
def output_priceadextension(data_object):
    ...
    output_status_message("Language: {0}".format(data_object.Language))
    output_status_message(
        "PriceExtensionType: {0}".format(data_object.PriceExtensionType)
    )
...
def output_pricetablerow(data_object):
    ...
    output_status_message(
        "TermsAndConditions: {0}".format(data_object.TermsAndConditions)
    )
    output_status_message(
        "TermsAndConditionsUrl: {0}".format(data_object.TermsAndConditionsUrl)
    )
...
def output_productaudience(data_object):
    ...
    output_status_message(
        "ProductAudienceType: {0}".format(data_object.ProductAudienceType)
    )
    output_status_message("TagId: {0}".format(data_object.TagId))
...
def output_productpartition(data_object):
    ...
    output_status_message(
        "ParentCriterionId: {0}".format(data_object.ParentCriterionId)
    )
...
def output_responsivead(data_object):
    ...
    output_status_message(
        "LongHeadlineString: {0}".format(data_object.LongHeadlineString)
    )
    output_status_message("Text: {0}".format(data_object.Text))
...
def output_schedule(data_object):
    ...
    output_date(data_object.StartDate)
    output_status_message(
        "UseSearcherTimeZone: {0}".format(data_object.UseSearcherTimeZone)
    )
...
def output_shoppingsetting(data_object):
    ...
    output_status_message(
        "LocalInventoryAdsEnabled: {0}".format(data_object.LocalInventoryAdsEnabled)
    )
...
def output_targetsettingdetail(data_object):
    ...
    output_status_message(
        "CriterionTypeGroup: {0}".format(data_object.CriterionTypeGroup)
    )
