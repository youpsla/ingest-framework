...
def output_accounttaxcertificate(data_object):
    ...
    output_status_message(
        "TaxCertificateBlobContainerName: {0}".format(
            data_object.TaxCertificateBlobContainerName
        )
    )
...
def output_advertiseraccount(data_object):
    ...
    output_status_message(
        "AccountFinancialStatus: {0}".format(data_object.AccountFinancialStatus)
    )
    output_status_message("Id: {0}".format(data_object.Id))
    ...
    output_status_message(
        "PaymentMethodType: {0}".format(data_object.PaymentMethodType)
    )
    ...
    output_status_message(
        "SalesHouseCustomerId: {0}".format(data_object.SalesHouseCustomerId)
    )
    output_status_message("TaxInformation:")
    output_array_of_keyvaluepairofstringstring(data_object.TaxInformation)
    output_status_message(
        "BackUpPaymentInstrumentId: {0}".format(data_object.BackUpPaymentInstrumentId)
    )
    output_status_message(
        "BillingThresholdAmount: {0}".format(data_object.BillingThresholdAmount)
    )
    ...
    output_status_message(
        "SoldToPaymentInstrumentId: {0}".format(data_object.SoldToPaymentInstrumentId)
    )
...
def output_clientlink(data_object):
    ...
    output_status_message(
        "ClientEntityNumber: {0}".format(data_object.ClientEntityNumber)
    )
    output_status_message("ClientEntityName: {0}".format(data_object.ClientEntityName))
    output_status_message(
        "ManagingCustomerId: {0}".format(data_object.ManagingCustomerId)
    )
    output_status_message(
        "ManagingCustomerNumber: {0}".format(data_object.ManagingCustomerNumber)
    )
    output_status_message(
        "ManagingCustomerName: {0}".format(data_object.ManagingCustomerName)
    )
    ...
    output_status_message("Status: {0}".format(data_object.Status))
    output_status_message(
        "SuppressNotification: {0}".format(data_object.SuppressNotification)
    )
    output_status_message(
        "LastModifiedDateTime: {0}".format(data_object.LastModifiedDateTime)
    )
    output_status_message(
        "LastModifiedByUserId: {0}".format(data_object.LastModifiedByUserId)
    )
    ...
    output_array_of_keyvaluepairofstringstring(data_object.ForwardCompatibilityMap)
    output_status_message(
        "CustomerLinkPermission: {0}".format(data_object.CustomerLinkPermission)
    )
...
def output_customer(data_object):
    ...
    output_status_message(
        "CustomerFinancialStatus: {0}".format(data_object.CustomerFinancialStatus)
    )
    output_status_message("Id: {0}".format(data_object.Id))
    ...
    output_status_message(
        "CustomerLifeCycleStatus: {0}".format(data_object.CustomerLifeCycleStatus)
    )
    output_status_message("TimeStamp: {0}".format(data_object.TimeStamp))
    output_status_message("Number: {0}".format(data_object.Number))
