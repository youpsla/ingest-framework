...
def write_entities_and_upload_file(bulk_service_manager, upload_entities):
    ...
    bulk_file_path = bulk_service_manager.upload_file(
        file_upload_parameters, progress=output_percent_complete
    )
...
def download_file(bulk_service_manager, download_parameters):
    bulk_file_path = bulk_service_manager.download_file(
        download_parameters, progress=output_percent_complete
    )
